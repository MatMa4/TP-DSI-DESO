...
public class HuespedDAOImpl implements HuespedDAO {
    ...
    private List<Huesped> cargarListaDesdeJSON() {
        ...
        File archivo = new File("TrabajoPractico/src/main/java/BDD/listaHuespedes.json");
    ...
    private void guardarListaEnJSON() {
        ...
        try {
            mapper.writeValue(new File("TrabajoPractico/src/main/java/BDD/listaHuespedes.json"), huespedes);
        } catch (IOException e) {
